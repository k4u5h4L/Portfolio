...
const greeting = {
    /* Your Summary And Greeting Section */
    username: "Kaushal",
    title: "Hey there, I'm Kaushal",
    subTitle: emoji(
        "An Information Science and Engineering student and and a Full Stack Developer based in Bengaluru."
    ),
    resumeLink: "#",
};
...
const skillsSection = {
    title: "What i do",
    subTitle: "Full stack developer passionate about these techologies",
    skills: [
        emoji("•  Develop interactive Front end / User Interfaces for your web applications"),
        emoji("•  Develop the backend for your web applications"),
        emoji("•  Deploy APIs for different purposes"),
    ],
...
const openSource = {
    ...
    githubUserName: "theParanoidScripts", // Change to your github username to view your profile in Contact Section.
...
const contactInfo = {
    ...
    subtitle: "Got a project in mind? Hit me up!",
    // number: "+91-YOUR_NUMBER",
    email_address: "kaushal.bhat@yahoo.com",
};
